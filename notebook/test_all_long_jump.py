...
for epi_idx in epi_idx_list:
    ...
    pth_path = './task_3_far_jump/final_weight/episode_%d.pth'%(epi_idx)
    ...
    for tick in range(max_epi_tick):
        ...
        if 'floor' in geom1s_prev and 'floor' not in geom1s_curr:
            ...
            if not initial_landed:
                ...
                # jump_distance = abs(p_torso_curr[0] - jump_start_pos[0])
